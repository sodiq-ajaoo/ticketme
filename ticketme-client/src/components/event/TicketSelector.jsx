    ...
    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl dark:border-slate-700 dark:bg-slate-900">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  {remaining > 0 ? (
                    <p className="mt-2 inline-block rounded-full bg-green-100 px-3 py-1 text-xs font-semibold text-green-700 dark:bg-green-900/30 dark:text-green-400">
                      {remaining} Tickets Left
                    </p>
                  ) : (
                    <p className="mt-2 inline-block rounded-full bg-red-100 px-3 py-1 text-xs font-semibold text-red-700 dark:bg-red-900/30 dark:text-red-400">
                      Sold Out
                    </p>
                  )}
                </div>
                ...
                <div className="flex items-center gap-3">
                  <button
                    onClick={() => decrease(ticket)}
                    className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 text-xl hover:bg-slate-200 dark:bg-slate-800"
                  >
                    -
                  </button>
                  ...
                  <button
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-600 text-xl text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-slate-400"
                  >
                    +
                  </button>
                </div>
      ...
      <div className="mt-8 border-t border-slate-200 pt-6 dark:border-slate-700">
        ...
        <button
          disabled={totalTickets === 0}
          onClick={handleCheckout}
          className="w-full rounded-2xl bg-blue-600 py-4 font-bold text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-slate-400"
        >
          Proceed to Checkout
        </button>
      </div>
